...
<div class="text-white min-h-screen flex flex-col justify-center items-center select-none overflow-hidden fixed inset-0">
    ...
    <div class="inline-flex space-x-2">
        <a id="button" href="https://steamcommunity.com/groups/lifehackbitch" aria-label="Steam Group" target="_blank">
        ...
        <a id="button" aria-label="Github" href="https://github.com/Invades/lifehackbit.ch" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
